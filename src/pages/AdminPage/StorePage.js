...
export default function StorePage() {
  ...
  const column = [
    ...
    { dataIndex: 'provinceId', title: 'Tỉnh/Thành phố', render: (val) => handleGetCountryNameById('province', val) },
    { dataIndex: 'districtId', title: 'Quận/Huyện', render: (val) => handleGetCountryNameById('district', val) },
    { dataIndex: 'wardId', title: 'Xã/Phường', render: (val) => handleGetCountryNameById('ward', val) },
